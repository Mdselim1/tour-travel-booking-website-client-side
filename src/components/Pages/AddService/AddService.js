...
const AddService = () => {
    ...
    return (
      ...
      <input placeholder="Enter your service price" {...register("pricing")} />
                <input placeholder="Enter your service img url" {...register("img")} />
                <textarea placeholder="Enter your service description" {...register("description")} cols="10" rows="5"></textarea>
